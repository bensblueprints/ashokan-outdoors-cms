...
export default function PageContent({ section, settings }: { section: Section | null; settings: Record<string, string> }) {
  const title = section?.title || 'Guided Fly Fishing in the Catskills'
  const subtitle = section?.subtitle || 'Fish legendary Catskill streams with expert local guides who\'ve spent three decades mastering these waters.'
  const heroImage = section?.image || '/images/fly-fishing-guide.jpg'
  const bodyParagraphs = section?.body?.split('\n\n').filter(Boolean) || [
    'Experience the thrill of fly fishing on the legendary rivers and streams of the Catskills.',
  ]
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="glass rounded-xl p-6">
                    ...
                    <p className="font-body text-stone-300 text-sm">We understand that the experienced angler values time on the water above all else. We&apos;ll guide you to great (some remote) spots, show you what insects the fish are interested in, and get out of your way.</p>
                  </div>
                  <div className="glass rounded-xl p-6">
                    <h4 className="font-body font-semibold text-creek-400 mb-2">Beginners</h4>
                    <p className="font-body text-stone-300 text-sm">We love teaching beginners. It is a great feeling to help a beginning angler catch their first trout on a fly. We&apos;ll provide patient, hands-on instruction every step of the way.</p>
                  </div>
                  <div className="glass rounded-xl p-6">
                    <h4 className="font-body font-semibold text-amber-400 mb-2">Mixed Groups</h4>
                    <p className="font-body text-stone-300 text-sm">One guide can usually handle up to three people. Beyond that, we&apos;ll arrange a second guide to make sure everyone gets the attention they require.</p>
                  </div>
                </div>
              </div>
            </div>
